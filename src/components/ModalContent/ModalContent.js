...
import {ADD_DISH, ADD_INGREDIENT} from "../../context/types";
          ...
          >
            ...
            <div className="dish__form">
              <div className="dish__container">
                <label htmlFor="dish" className="dish__name">
                  <input
                      ...
                      id="dish"
                      value={dishName}
                      onChange={text => this.setState({dishName: text.target.value})}
                      maxLength={50}
                  />
                ...
                <label htmlFor="dishSelect" className="dish__select">
                  <select
                      ...
                      id="dishSelect"
                      value={dishType}
                      onChange={text => this.setState({dishType: text.target.value})}
              ...
              <textarea
                  ...
                  onChange={text => this.setState({dishDescription: text.target.value})}
                  maxLength={150}
              />
                  ...
                  <div className="ingredients__prepare">
                    ...
                    >
                      ...
                      <input
                          ...
                          id="ingredient"
                          value={ingredient}
                          onChange={text => this.setState({ingredient: text.target.value})}
                      />
                      <Plus
                    ...
                    >
                      <input
                          ...
                          id="kcl"
                          value={kcl}
                          onChange={text => this.setState({kcl: text.target.value})}
                      />
                      <button
